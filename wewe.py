...
def main():
    ...
    public_key_path_label = tk.Label(window, text="Public Key Path:")
    public_key_path_label.pack()
    public_key_path_entry = tk.Entry(window)
    public_key_path_entry.pack()

    private_key_path_label = tk.Label(window, text="Private Key Path:")
    private_key_path_label.pack()
    private_key_path_entry = tk.Entry(window)
    private_key_path_entry.pack()

    encrypt_button = tk.Button(window, text="Encrypt File",
                               command=lambda: encrypt_file(file_path_entry.get(), public_key_path_entry.get(),
                                                          recipient_hostname_entry.get(),
                                                          recipient_username_entry.get(),
                                                          recipient_password_entry.get()))
    encrypt_button.pack()

    decrypt_button = tk.Button(window, text="Decrypt File",
                               command=lambda: decrypt_file(file_path_entry.get(), private_key_path_entry.get(),
                                                          sender_hostname_entry.get(),
                                                          sender_username_entry.get(),
